    ...
    <div className="relative px-[10%] text-center w-full h-full flex items-center justify-center flex-col gap-4 bg-black text-white border-2 border-solid border-white py-16">
      ...
      <div className="border border-solid border-white md:border-2 border-solid border-white px-6 py-4 sm:border border-solid border-white px-4 py-2">
        <h2 className="text-sm font-md leading-3 md:leading-7 pb-4 text-xl font-bold sm:leading-5 pb-2 text-sm font-normal">
          "Rudra Resto, which means “Rudrapur Restaurent” in Uttarakhand, India,
          is just that – a compilation of lively dining experiences. Rudra
          celebrates the best of Indian dishes with welcoming hospitality and
          service. Seasonal changes guide the menu of scratch-made pasta made
          in-house daily, cheeses, antipastis, pizzas and more. Staying true to
          Indian dining traditions, Rudra also offers a “For the Table” dining
          option curated for a family-style experience, offered nightly
